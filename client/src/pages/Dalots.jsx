...
const Dalots = () => {
    ...
    const fetchSections = useCallback(async () => {
        try {
            const res = await axios.get('/api/dalots/sections');
            const data = res.data;
    ...
    const fetchDalots = useCallback(async () => {
        try {
            ...
            const res = await axios.get('/api/dalots', { params });
            setDalots(res.data.data || []);
        } catch (err) {
    ...
    const fetchStats = useCallback(async () => {
        try {
            const res = await axios.get('/api/dalots/stats');
            setStats(res.data.data || { total: 0, finished: 0, in_progress: 0, cancelled: 0, validated: 0 });
        } catch (err) {
    ...
    const handleImport = async () => {
        ...
        try {
            const res = await axios.post('/api/dalots/import', {
